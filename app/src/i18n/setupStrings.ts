...
const en: SetupCopy = {
  ...
  phObjDesc: 'the blue one with a red lid',
  phRoomName: 'e.g. Kitchen',
  phRoomDesc: 'where he has his morning coffee',
  capCancel: 'Cancel',
  capUse: 'Use photo',
  capRetake: 'Retake',
...
const es: SetupCopy = {
  ...
  phObjDesc: 'el azul de tapa roja',
  phRoomName: 'ej. Cocina',
  phRoomDesc: 'donde toma el café por la mañana',
  capCancel: 'Cancelar',
  capUse: 'Usar foto',
  capRetake: 'Repetir',
