...
const en: SetupCopy = {
  ...
  emptyObjBody: 'Tag the things you ask about — your thermos, your pills, the remote. Each one becomes an answer to “where is…?”',
  emptyObjCta: 'Add your first object',
  emptyRoomTitle: 'No rooms yet',
  emptyRoomBody: 'Map the rooms you move through, so Lola can tell you where you are. A few photos per room is all it takes.',
  ...
  heartbeatHint: 'A gentle pulse every few seconds on the home screen so you can feel the app is on and ready.',
  yourName: 'Your name',
  ...
  phObjName: 'e.g. your thermos',
  phObjDesc: 'e.g. the blue one with a red lid',
  phRoomName: 'e.g. Kitchen',
  phRoomDesc: 'e.g. where you have your morning coffee',
  capCancel: 'Cancel',
  capUse: 'Use photo',
  capRetake: 'Retake',
...
const es: SetupCopy = {
  ...
  emptyObjBody: 'Etiquetá las cosas que buscás — tu termo, tus pastillas, el control. Cada una es una respuesta a “¿dónde está…?”',
  emptyObjCta: 'Agregá tu primer objeto',
  emptyRoomTitle: 'Todavía no hay cuartos',
  emptyRoomBody: 'Marcá los cuartos por donde te movés, así Lola puede decirte dónde estás. Con unas pocas fotos por cuarto alcanza.',
  ...
  heartbeatHint: 'Un pulso suave cada pocos segundos en la pantalla principal para que sientas que la app está encendida y lista.',
  yourName: 'Tu nombre',
  yourNameHint: 'Cómo te saluda Lola al abrir la app.',
  yourNamePh: 'ej. Carlos',
  language: 'Idioma de ajustes',
  langSpanish: 'Español',
  langEnglish: 'English',
  voice: 'Voz',
  ...
  phObjName: 'ej. tu termo',
  phObjDesc: 'ej. el azul de tapa roja',
  phRoomName: 'ej. Cocina',
  phRoomDesc: 'ej. donde tomás el café por la mañana',
  capCancel: 'Cancelar',
  capUse: 'Usar foto',
  capRetake: 'Repetir',
