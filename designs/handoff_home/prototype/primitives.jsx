...
const ICON_PATHS = {
  ...
  eye: (s) => <g fill="none" stroke="currentColor" strokeWidth={s} strokeLinecap="round" strokeLinejoin="round"><path d="M2 12s3.8-7 10-7 10 7 10 7-3.8 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3.1"/></g>,
  askbubble: (s) => <g fill="none" stroke="currentColor" strokeWidth={s} strokeLinecap="round" strokeLinejoin="round"><path d="M20.5 11.3a8.2 8.2 0 0 1-11.7 7.4L3.5 20.2l1.5-5.1A8.2 8.2 0 1 1 20.5 11.3z"/><path d="M9.8 9.4a2.3 2.3 0 0 1 4.4.9c0 1.6-2.1 2-2.1 3.4"/><path d="M12 16.4v.05"/></g>,
  scene: (s) => <g fill="none" stroke="currentColor" strokeWidth={s} strokeLinejoin="round"><rect x="3" y="5" width="18" height="14" rx="2.6"/><circle cx="8.4" cy="10" r="1.7"/><path d="M3 16.2l4.6-3.8 3.4 2.7 3.2-2.6L21 17"/></g>,
  qmark: (s) => <g fill="none" stroke="currentColor" strokeWidth={s} strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9"/><path d="M9.4 9.4a2.6 2.6 0 0 1 5 1c0 1.8-2.5 2.2-2.5 3.9"/><path d="M12 17.2v.05"/></g>,
};
